...
from telegram import BotCommand, InlineKeyboardButton, InlineKeyboardMarkup, ParseMode
from telegram.ext import CommandHandler, run_async

from bot import IMAGE_URL, app, botStartTime, dispatcher, updater
...
"""
    update.effective_message.reply_photo(
        IMAGE_URL, start_string, parse_mode=ParseMode.MARKDOWN
    )
    ...
    button = [
        [
            InlineKeyboardButton(
                "Repo", url=f"https://github.com/breakdowns/slam-mirrorbot"
            )
        ],
...
def main():
    ...
    repo_handler = CommandHandler(
        BotCommands.RepoCommand,
        repo,
        filters=CustomFilters.authorized_chat | CustomFilters.authorized_user,
    )
